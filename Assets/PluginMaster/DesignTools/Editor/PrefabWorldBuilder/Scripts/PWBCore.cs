    ...
    public class PWBShortcuts
    {
        ...
        public static PWBShortcuts GetDefault(int i)
        {
            ...
            else if (i == 2)
            {
                ...
                d0.pinRotate90YCCW.combination.Set(KeyCode.S, EventModifiers.Alt);
                d0.pinRotateAStepYCW.combination.Set(KeyCode.S, EventModifiers.Shift);
                d0.pinRotateAStepYCCW.combination.Set(KeyCode.S, EventModifiers.Shift | EventModifiers.Alt);

                d0.pinRotate90XCW.combination.Set(KeyCode.V);
                d0.pinRotate90XCCW.combination.Set(KeyCode.V, EventModifiers.Alt);
                d0.pinRotateAStepXCW.combination.Set(KeyCode.V, EventModifiers.Shift);
                d0.pinRotateAStepXCCW.combination.Set(KeyCode.V, EventModifiers.Shift | EventModifiers.Alt);

                d0.pinRotate90ZCW.combination.Set(KeyCode.B);
                d0.pinRotate90ZCCW.combination.Set(KeyCode.B, EventModifiers.Alt);
                d0.pinRotateAStepZCW.combination.Set(KeyCode.B, EventModifiers.Shift);
                d0.pinRotateAStepZCCW.combination.Set(KeyCode.B, EventModifiers.Shift | EventModifiers.Alt);
                ...
                d0.selectionRotate90YCCW.combination.Set(KeyCode.S, EventModifiers.Alt);
                d0.selectionRotate90XCW.combination.Set(KeyCode.V);
                d0.selectionRotate90XCCW.combination.Set(KeyCode.V, EventModifiers.Alt);
                d0.selectionRotate90ZCW.combination.Set(KeyCode.B);
                d0.selectionRotate90ZCCW.combination.Set(KeyCode.B, EventModifiers.Alt);
        ...
        private PWBTwoStepKeyShortcut _gridNextOrigin = new PWBTwoStepKeyShortcut("Set next origin",
           PWBShortcut.Group.GRID, KeyCode.N, EventModifiers.Control | EventModifiers.Alt);
